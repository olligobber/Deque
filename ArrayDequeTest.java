...
public class ArrayDequeTest {
	...
	public void testLenientAddition() {
		Deque<Integer> test = new ArrayDeque<Integer>(0);
		
		assertFalse(test.offerFirst(1));
		assertFalse(test.offerLast(2));
		
		test = new ArrayDeque<Integer>(2);
	...
	public void smallTest() {
		Deque<Integer> test = new ArrayDeque<Integer>(10);
		test.addLast(2);
		assertTrue(test.offerFirst(-1));
	...
	public void testString() {
		Deque<String> test = new ArrayDeque<String>(3);
	...
	public void testNull() {
		Deque<Object> test = new ArrayDeque<Object>(3);
